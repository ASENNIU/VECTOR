...
class AllConfig(Config):
    ...
    def parse_args(self):
        ...
        parser.add_argument("--frozen_clip", type=int, default=1)
        ...
        # caption handle parameters
        parser.add_argument('--text_patch', type=int, default=12, help='K value for text patch select')
        # system parameters
